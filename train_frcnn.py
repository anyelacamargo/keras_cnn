...
with open(config_output_filename, 'wb') as config_f:
	...
	print('Config has been written to {}, and can be loaded when testing to' \
	'ensure correct results'.format(config_output_filename))
...
epoch_length = 100 
## FIXME changed epochs to 100 from 1000
